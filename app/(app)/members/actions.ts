...
function readSaleFields(formData: FormData) {
  ...
  return {
    ...
    discountReason: text('saleDiscountReason'),
    discountNote: text('saleDiscountNote'),
...
export async function createMember(
  ...
  try {
    ...
    result = await registerMember({
      ...
      discountReason: selling ? sale.data.discountReason : null,
      discountNote: selling ? sale.data.discountNote : null,
